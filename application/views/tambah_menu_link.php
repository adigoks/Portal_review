...
<body>
	...
	<fieldset>
		...
		<form class="col-md-4 form-horizontal" action="<?php echo site_url('admin_menu/menu_tambah_link'); ?>" method="POST">
			...
			<div class="form-group">
					<label class="" for="link">External Link :</label>
					<input class="col-sm-5 form-control" type="text" name="link" />
			</div>
