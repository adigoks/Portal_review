			...
			foreach ($list as $key) {
				...
				if($key['menu_parent'] == 0){
					...
					echo "	
							<li id='menu-$name' class='panel panel-default'>
								...
								<div class='panel-heading'>
									<a data-toggle='collapse' data-parent='#parent-menu' href='#sub-menu-$name'>
										<button form='' class='btn btn-default view-sub' target='sub-menu-$name'>
											<span class='glyphicon glyphicon-triangle-bottom'></span>
										</button>
										<button form='' class='btn btn-default view-parent' target='sub-menu-$name' style='display:none'>
									...
									<ul id='sub-menu-$name' class='panel-collapse collapse'>";
					...
					foreach ($list as $key1) {
						...
						{
							$j++;
							$name1 = str_replace(" ", "-", $key1['menu_name']);
							echo "	
									<li id='sub-$parent-$name1' class='sub-menu config'>
